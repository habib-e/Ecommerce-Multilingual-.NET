    ...
    public partial class addForeignKeyForCategoryProductRelation : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 3, 9, 3, 40, 3, 51, DateTimeKind.Local).AddTicks(8853), "9", "Web Development" },
                    { 2, new DateTime(2024, 3, 9, 3, 40, 3, 51, DateTimeKind.Local).AddTicks(8871), "8", "Programming" },
                    { 3, new DateTime(2024, 3, 9, 3, 40, 3, 51, DateTimeKind.Local).AddTicks(8872), "7", "Databases" },
                    { 4, new DateTime(2024, 3, 9, 3, 40, 3, 51, DateTimeKind.Local).AddTicks(8872), "6", "Networking" },
                    { 5, new DateTime(2024, 3, 9, 3, 40, 3, 51, DateTimeKind.Local).AddTicks(8873), "5", "Security" }
                });
